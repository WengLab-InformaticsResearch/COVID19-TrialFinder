...
function initMap() {
  map = new google.maps.Map(document.getElementById('map'), {
    zoom: 9,
    center: {lat: 40.8412426, lng: -73.9431593},
...
function generate_trial_info_modal(nct_id) {
    ...
    $.getJSON($SCRIPT_ROOT + '/_retrieve_modal_data', {
        ...
        .done(function () {
            ...
            // modal.style.display = "block"; //fengyang: block style
        })
}
...
$(document).ready(function () {
        ...
        function () {
            ...
            $.getJSON($SCRIPT_ROOT + '/_check_homepage_parameters', {
                ...
                function (data) {
                    ...
                    //fengyang: add zipcode
                    // nearby_zip_list = data.nearby_zip_list;
                    // $('#nearby_zip_list').val(data.nearby_zip_list);
                    // console.log("search_button2");
                    nearby_zip_list = data.nearby_zip_list;
                    //console.log(nearby_zip_list);
    ...
    $('#confirm_close_question').bind('click',
        ...
        function () {
            window.location.href = '/dquest-flask';
    ...
    $("#skip_mq_button").click(function () {
        $('#pre_questions_age').val(99999);
        $('#pre_questions_exposure').val('idk');
        $('#pre_questions_domain').val('idk');
        $('#pre_questions_patient_stat').val('idk');
        $('#pre_questions_patient_preg').val('idk');
